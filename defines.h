...
#define TIME_BTW_ANIMATIONS 250
//SPRITE RELATED
...
#define SOURCE_POS_PLAYER_KNELT_Y SPRITE_HEIGHT * 2
...
#define SOURCE_POS_PLAYER_STANDING_RIGHT_LIMIT_X SPRITE_WIDTH * 3 + 2
...
#define SOURCE_POS_PLAYER_STANDING_LEFT_Y SPRITE_HEIGHT
